                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="../LogoutController"><i class="icon-signout"></i> Logout </a>
                            </li>
                        </ul>
       ...
       <div id="left" >
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel active">
                    <a href="pricing.jsp" >
                        <i class="icon-table"></i> Trial/Premium Pack
                ...
                <li class="panel ">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle collapsed" data-target="#form-nav">
                        <i class="icon-pencil"></i> Profiles
                    ...
                    <ul class="collapse" id="form-nav">
                        <li class=""><a href="forms_general.html"><i class="icon-angle-right"></i> User Profiles </a></li>
                        <li class=""><a href="forms_advance.html"><i class="icon-angle-right"></i> Teacher Profiles</a></li>
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h1> Admin Dashboard <% String username =(String)session.getAttribute("username");
