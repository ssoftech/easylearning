...
<%@page import="edu.easylearning.service.ChapterService"%>    
<!DOCTYPE html>
...
<!--[if lt IE 9]>
  ...
  {
  	alert(id+"asdasdasd");
  	location.href="../ChapterController?id="+id;
...
<body class="padTop53 " onload="hide()">
	...
	<div id="wrap">
								...
								<form action="../ChapterController" method="post" class="form-horizontal">
										...
										<select required="required" class="form-control" name="standard">
											<option value="Id" selected="selected"> Standard Name </option>
											 ...
											 <%
											  ChapterService c = new ChapterService();

												ArrayList<Standard> entityList = c.findonestandard();
										...
										<select required="required" class="form-control" name="subject">
											<option value="Id" selected="selected"> Subject Name </option>
											 ...
											 <%
											  ChapterService cc = new ChapterService();

												ArrayList<Subject> entityList1 = cc.findonesubject();
				...
				<div class="row" id=1>
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Chapter Table</div>
     ...
     <% ChapterService ss =new ChapterService();   
