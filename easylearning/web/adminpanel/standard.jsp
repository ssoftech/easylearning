...
<%@page import="edu.easylearning.service.StandardServices, edu.easylearning.dao.*,java.util.ArrayList,edu.easylearning.model.*"%>
...
<link rel="stylesheet"
    ...
    function delet(id)
    {
    	location.href="../StandardController?id="+id;
...
<body class="padTop53 " onload=hide()>
	...
	<div id="wrap">
							...
							<div id="collapseOne" class="accordion-body collapse in body">
								<form action="../StandardController"    method="post" class="form-horizontal">
									 ...
									 <!-- <div class="form-group">
										...
										<div class="col-lg-3">										
										<input type="text" name ="standard" id="standard" style="width: 220px;">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">Standard Table</div>
     ...
     <% StandardServices c =new StandardServices();   
  
     
     ArrayList<Standard> entityList =c.findAll();
