...
<body class="padTop53 " onload="hide()">
	...
	<div id="wrap">
					...
					<div class="col-lg-12">
						<div class="box">
							...
							<div id="collapseOne" class="accordion-body collapse in body">
								<form action="../CategoryController" method="post" class="form-horizontal">
     ...
     ArrayList<Category> entityList =c.findAll();
											...
											<tr class="odd gradeX">
                                                ...
                                                <td><%=entityList.get(i).getName()%></td>
                                                 <td><input type="button" id="action" name ="action" value="Edit" onclick="edit(<%=entityList.get(i).getId()%>,'<%=entityList.get(i).getName()%>')" > 
                                                     <input type="button" id="action" name ="action" value="Delete" onclick="s(<%=entityList.get(i).getId()%>)" >
                                                  </td>
